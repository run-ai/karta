...
- `hack/e2e/` End-to-end cluster provisioner and per-operator install modules (see `hack/e2e/README.md`)
...
The end-to-end suite provisions a kind cluster with the real upstream operators and runs Karta against live workloads. To add an operator to it, follow `hack/e2e/README.md` (the install module) and `test/e2e/README.md` (the test case).
