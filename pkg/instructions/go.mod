module github.com/run-ai/karta/pkg/instructions
...
require (
	...
	github.com/run-ai/karta/pkg/resource v0.0.0-00010101000000-000000000000
...
replace github.com/run-ai/karta/pkg/resource => ../resource
