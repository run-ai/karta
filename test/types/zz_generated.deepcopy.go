...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MilvusComponentSpec) DeepCopyInto(out *MilvusComponentSpec) {
	*out = *in
	if in.Replicas != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MilvusComponentSpec.
func (in *MilvusComponentSpec) DeepCopy() *MilvusComponentSpec {
	if in == nil {
		return nil
	}
	out := new(MilvusComponentSpec)
	in.DeepCopyInto(out)
	return out
}
