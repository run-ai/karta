...
var _ = BeforeSuite(func(ctx SpecContext) {
	...
	// A builtin type has no operator; the Kubernetes version is what defines its behavior,
	// so its recordings are filed under it (operatorVersion falls back here).
