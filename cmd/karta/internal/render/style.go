...
// useful when the user passes --color=always.
...
// Ratio colors a "got/want" pair: green when got >= want, yellow when partial,
// red when nothing is ready against a non-zero want.
